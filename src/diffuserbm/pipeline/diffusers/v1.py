...
class StableDiffusionBenchmarkPipeline(BenchmarkPipeline, type='v1', name='diffusers.v1'):
    ...
    def __call__(self, prompt, width, height, **kwargs) -> ndarray:
        ...
        :param denoising_steps: number of inference step to denoising, default 15 for SD 1.5
        :param guidance_scale: scale of guidance for the generating image, default 0.0 for SD 1.5
        :return: ndarray type image
        """
        negative = kwargs.get('negative', '')
        rand_gen = kwargs.get('rand_gen', None)
        denoising_steps = kwargs.get('denoising_steps', 15)
